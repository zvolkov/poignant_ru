html : book/* templates/*
	...
	pandoc -f markdown -t html book/ch3.markdown -s --template=templates/chapter.template -c guide.css --indented-code-classes="brush: ruby" -o html/ch3.html -H templates/google_analytics.inc -V lang=ru
ftp : html/*
	mkdir -p publish
	rm -rf publish/*
