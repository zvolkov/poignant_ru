...
html/ch3.html : book/ch3.markdown book/author.markdown templates/chapter.template templates/google_analytics.inc | html
	pandoc -f markdown -t html book/author.markdown book/ch3.markdown -s --template=templates/chapter.template -c guide.css --indented-code-classes="brush: ruby" -V nextlink=ch4.html -V lang=ru -H templates/google_analytics.inc -o html/ch3.html

html/ch4.html : book/ch4.markdown book/author.markdown templates/chapter.template templates/google_analytics.inc | html
	pandoc -f markdown -t html book/author.markdown book/ch4.markdown -s --template=templates/chapter.template -c guide.css --indented-code-classes="brush: ruby" -V lang=ru -H templates/google_analytics.inc -o html/ch4.html
...
html/copyright.html : book/copyright.markdown book/author.markdown templates/chapter.template templates/google_analytics.inc | html
	pandoc -f markdown -t html book/author.markdown book/copyright.markdown -s --template=templates/chapter.template -c guide.css -V lang=ru -H templates/google_analytics.inc -o html/copyright.html

html/help.html : book/help.markdown book/author.markdown templates/chapter.template templates/google_analytics.inc | html
	pandoc -f markdown -t html book/author.markdown book/help.markdown -s --template=templates/chapter.template -c guide.css -V lang=ru -H templates/google_analytics.inc -o html/help.html
