...
Всё остальное в Руби насквозь пропитано позитивом. Кажется, Руби родился из какой–то очень хорошей мысли, и она прошла через все объекты, строчки, и регэкспы.
...
Пишется он примерно как распространённая форма блока `do`/`end` из предыдущей главы, в том смысле что в конце тоже ставится `end`:
    ...
    if stakanchik
        print "В стаканчике что–то есть"
    end
