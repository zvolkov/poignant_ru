...
=======================================================
![o](images/chapter.poignant.guide-4.jpg?raw=true)\ 

![Глубоко–глубоко в Пещерах Амбрэ, жил–был Эльф Сколбасой](images/the.elf-1.png?raw=true) ![и чёрный кот по кличке Негыр](images/the.elf-2.png?raw=true) Вообще–то, мы как–раз к Эльфу и пришли, он будет играть важную роль в сегодняшнем уроке. (Кстати, первый раз слышу про разумную колбасу — я думал они только на сковородках шкварчать умеют.)
...
![Народ не верит в самоцветы](images/the.elf-3.png?raw=true)
...
![Лаборатория электронных имплантантов](images/the.elf-4.jpg?raw=true)
...
![Ловим звёздочку](images/the.elf-5a.jpg?raw=true)
...
![Прикручиваем звёздочку к обезьяне](images/the.elf-5b.jpg?raw=true)
...
![Жаба](images/the.elf-5c.png?raw=true)
...
![Алё](images/blix-1.png?raw=true)
...
![Силуэт кота](images/blix-neg.gif?raw=true) 
...
В этом примере мы вызываем метод `==` у объекта `nil` и передаём ему параметр `true`.
...
Кусок кода между `else` и `end` выполнится только если `if` не сработал («else» значит «иначе»).
