...
Идём дальше. Допустим, труба поймала звездочку, что дальше? Куда она потом идёт?
...
В данном примере, если звездочку не положить в переменную, то она просто выпадет из трубы и исчезнет. Бедненькая.

Спрашивается, зачем вызывать метод если тебе не нужен результат? Умный человек так делать не станет — переводняк!
