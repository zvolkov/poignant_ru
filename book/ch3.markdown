...
…этот код сначала достаёт веб–страничку, потом мы просим страничку выдать нам `body`, т.е. «тело» веб—страницы в виде *строчки* содержащей HTML-код.
...
Итак, что делает весь этот код? Он печатает на экран HTML–код заглавной страницы сайта про Руби — с помощью специально обученного водителя :^)
