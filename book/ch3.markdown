...
## 5. Мягкое и плавное возвращение на землю

![Лисы гонятся за машиной](images/the.foxes-8.png)\ 

Кажется, у нас проблемы… У меня такое чувство, что тебе понравилось, даже очень. А ведь мы ещё даже не дошли до считалочек про XML!

Если тебе *правда* такое нравится, значит всё, хана! Через пару глав ты сможешь писать собственные программы.
Кстати, как раз через две главы мы попробуем написать ролевую игру, файло–обменную сеть (типа Битторента), и программу для скачивания из сети *настоящих* случайных чисел!

Ты, наверное, уже догадываешься (и я должен тебя предупредить!) что всё пропало. Во–первых, ты перестанешь гулять с собакой.
Она будет крутится возле двери, просится — но твои глаза будут заняты программой, а твои пальчики будут стучать по клавишам.

Через некоторое время, начнут ломаться вещи. Вентиляция забъётся распечатками програм. Сдохнет кондик. Накопятся горы мусора: коробки от пицы (некогда готовить), бесплатные рекламные рассылки (некогда выкидывать). Воздух в квартире будет пахнуть немытым телом. Стены покроются мхом, забъётся канализация, сквозь дыры в стенах залезут звери, деревья прорастут сквозь пол.
