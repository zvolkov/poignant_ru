...
Как и простые методы, классные методы приклеиваются к переменным и константам, 
...
Глобальные переменные можно назначить в одном месте программы, а потом прочитать в любом другом месте.
