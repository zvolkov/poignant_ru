...
Есть еще такая штука: «ядерные методы», например `print`. Для удобства, ядерные методы можно вызывать без точки:
...
А еще, блок похож на маленький красивый пенальчик с карандашами и резинками, с прозрачной крышечкой, сквозь которую видно, что внутри.
